              ...
              return Column(
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      Text(
                        "الإسـم  : ${state.data.data.name.toString()}",
                        style: TextStyle(
                            //    color: Colors.white,
                            fontSize: 13.sp,
                      ...
                      Gaps.vGap10,
                      Text(
                        "الكـود  : ${state.data.data.mCode.toString()}",
                        style: TextStyle(
                            //         color: Colors.white,
                            fontSize: 13.sp,
                            fontWeight: FontWeight.w900),
                      ...
                      Gaps.vGap10,
                      Text(
                        "الفرع : ${state.data.data.branchName.toString()}",
                        style: TextStyle(
                            //    color: Colors.white,
                            fontSize: 13.sp,
                            fontWeight: FontWeight.w900),
                      ...
                      Gaps.vGap10,
                      Text(
                        "الجـوال : ${state.data.data.phone.toString()}",
                        style: TextStyle(
                            //    color: Colors.white,
                            fontSize: 13.sp,
                            fontWeight: FontWeight.w900),
                  ...
                  Gaps.vGap5,
                  CustomCashedNetworkImage(
                    imageUrl: "${state.data.data.barcodePath!}",
