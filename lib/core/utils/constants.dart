...
const String kWelcomeScreenRoute = "/KWelcomeScreen";
...
Color getPrimaryColor() {
  final boxCode = Hive.box<CodeEntity>(kCodeDataBox);
  return HexColor(boxCode.get(kCodeDataBox)?.color ?? '#6953C2');
}

Color kPrimaryColor = getPrimaryColor();
