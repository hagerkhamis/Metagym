...
import '../../../features/code/data/dat_source/login_remote_data_source/code_remote_data_source.dart';
import '../../../features/code/data/repository/code_implementation.dart';
import '../../../features/code/domain/repository/code_repo.dart';
import '../../../features/code/domain/use_cases/code_use_case.dart';
import '../../../features/code/presentation/manger/code_cubit.dart';
...
///////////////////
  ///
  ///  Code
  getIt.registerFactory<CodeCubit>(() => CodeCubit(getIt.call()));

  getIt.registerLazySingleton<CodeUseCase>(() => CodeUseCase(getIt.call()));

  getIt.registerLazySingleton<CodeRepository>(() => CodeRepoImpl(getIt.call()));

  getIt.registerLazySingleton<CodeRemoteDataSource>(
      () => CodeRemoteDataSourceImpl());
