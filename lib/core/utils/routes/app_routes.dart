...
import 'package:gyms/features/code/presentation/views/code_view.dart';
import 'package:gyms/features/code/presentation/views/code_welcome_view.dart';
  ...
  static Route? onGenerateRoute(RouteSettings routeSettings) {
    ...
    switch (routeSettings.name) {
      ...
      case kWelcomeScreenRoute:
        return MaterialPageRoute(
          builder: (context) => const CodeWelcomeView(),
        );
